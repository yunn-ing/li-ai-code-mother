package com.liyurui.yuaicodemother.core;

import com.liyurui.yuaicodemother.ai.AiCodeGeneratorService;
import com.liyurui.yuaicodemother.ai.model.HtmlCodeResult;
import com.liyurui.yuaicodemother.ai.model.MultiFileCodeResult;
import com.liyurui.yuaicodemother.core.parser.CodeParserExecutor;
import com.liyurui.yuaicodemother.core.saver.CodeFileSaverExecutor;
...
/**
 * AI 代码生成外观类，组合生成和保存功能    采用门面模式--外观类封装复杂子系统的调用逻辑，提供简单统一的接口
 */
@Service
@Slf4j
